                        ...
                        <ul class="navbar-nav items col-md-10 p-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu newmenu">
                                    <ul>
                                        <li class="nav-item">
                                            <a href="service1" class="nav-link <?php echo ($currentPage == 'Tax_Preparation_Service') ? 'active' : ''; ?>">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="service3">Corporate Tax Services</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="service4" class="nav-link <?php echo ($currentPage == 'Multistate_Tax_Preparation_Service') ? 'active' : ''; ?>">
                                                Audit & Assurance Services
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" href="service5">ICV & ISO Certificates </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="service6">Payroll</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="service7">Company Formation & Liquidation</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="service8">Golden Visa Services</a>
                                        </li>
