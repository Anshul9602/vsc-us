        ...
        <div class="row">
                ...
                <div class="row intro m-0">
                    <div class="col-12">
                        ...
                        <div class="title-icon">
                            <h2><span class="featured"><span><i class="icon icon-wallet"></i>Payroll</span></span> Management</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 align-self-center">
                        ...
                        <ul>
                            <li>Constant coordination with your HR department</li>
                            <li>Wage protection system (WPS) coverage</li>
                            <li>End-of-service settlements calculations</li>
                            <li>Preparation of detailed accrual reports</li>
                        </ul>

                        <h5>On-Time Services</h5>
                        ...
                        <ul>
                            ...
                            <li>Secure management of employee payroll information</li>
                        </ul>

                        <h5>Customizable Service</h5>
                        <p>We understand that each business has unique payroll needs. Our customizable payroll solutions include:</p>
                        <ul>
                            <li>Salary payments in multiple currencies</li>
                            <li>Customized payslip formats</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <aside class="col-12 col-lg-4 pl-lg-5 p-0 float-right sidebar">
                ...
                <div class="row item widget-services">
                    <div class="col-12 align-self-center">
                        <h4 class="title">Our Payroll Services</h4>
                        <div class="quote">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-start align-items-center">
                                    <a href="#"><i class="icon icon-briefcase"></i></a>
                                    <div class="list-group-content">
                                        <h4>Wage Protection</h4>
                                        <p>Secure salary processing through WPS coverage.</p>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex justify-content-start align-items-center">
                                    ...
                                    <div class="list-group-content">
                                        <h4>Data Security</h4>
                                        <p>Confidentiality ensured with secure systems.</p>
                                    </div>
                                </li>
                                <li class="list-group-item d-flex justify-content-start align-items-center">
                                    ...
                                    <div class="list-group-content">
                                        ...
                                        <p>Tailored payroll services to suit your needs.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="col-12 col-md-6 pr-md-5 align-self-top text">
                <div class="row items">
                    <div data-aos="fade-up" class="col-12 col-md-6 p-0 pr-md-4 mb-2 item">
                        ...
                        <h4>Success Rate</h4>
                        <p>High success rate in payroll management across UAE businesses.</p>
                    </div>
                    <div data-aos="fade-up" class="col-12 col-md-6 p-0 pr-md-4 mb-2 item">
                        ...
                        <h4>Experience</h4>
                        <p>Years of expertise in payroll solutions for various industries.</p>
                    </div>
                </div>
            </div>
        </div>
