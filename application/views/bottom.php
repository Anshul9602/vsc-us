    ...
    <div class="" style="max-width: 95%; margin:auto;">
        <div class="row">
            <div class="col-md-4">
                ...
                <p>With our expert assistance, forget the worries of handling complex tax litigation challenges alone!</p>
            </div>
            <div class="col-md-8">
                <!-- Accordion 6 - Bootstrap Brain Component -->
                <section class="bsb-accordion-6 py-3">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body" style="color:#000">
                                               <ul>
                                                ...
                                                <li>Support in the preparation and submission of various applications to the relevant authorities for Mutual Agreement Procedure (MAP) under tax treaties</li>
                                                <li>Guiding counsel with the preparation and presentation of appeals/petitions before high courts and the Supreme Court.</li>
                                                <li>Examining any tax evasion or other arrangements to identify hazards</li>
                                                <li>Providing advice on tax evasion investigations and settlement alternatives, including withdrawal from agreements</li>
                                                <li>Ensuring that HMRC does not violate statutory time limitations or its discovery and inquiry capabilities.</li>
                                               </ul>
                                               <p >In addition to strategic expertise, we have specific substantive tax experience in several areas, including:</p>
                                               <ul>
                                                ...
                                                <li>Taxation of Native American tribal governments and their enterprises</li>
